#If you specify a slice with three parameters S[a:\b:d]:
...
#Fun Fact: if the step of the slice equals to -1,
    #the characters go in reverse order. :) You can reverse a string S with this: S[::-1].
s = 'abcdefg'
print(s[1])
print(s[-1])
print(s[1:3])
