...
#You can pass the third argument count using replace() method, like this: s.replace(old, new, count). 
#If the third argument is passed:
    #only first count occurrences are replaced.
